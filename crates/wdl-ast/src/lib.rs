...
pub trait HasBlock: AstNode<SyntaxNode> {
    /// Get the [`TextRange`] of the body, including the open/close delimiters.
    fn body(&self) -> TextRange {
...
/// Implementation for [`HasBlock::body()`].
...
impl Comment {
    ...
    pub fn kind(&self) -> CommentKind {
        ...
        } else if self.text().ends_with(DIRECTIVE_COMMENT_PREFIX) {
